...
import { 
  ...
  FileImage, Settings2, Info, ChevronDown, CheckCircle2, TableProperties, Loader2
} from 'lucide-react';
...
const BankCalculator: React.FC = () => {
  ...
  // --- INPUT STATES ---
  const [loanAmount, setLoanAmount] = useState<string>('500.000.000');
  ...
  // Phase 1 (Fixed)
  const [phase1Rate, setPhase1Rate] = useState<number>(7.5);
  const [phase1Duration, setPhase1Duration] = useState<number>(12); // months
